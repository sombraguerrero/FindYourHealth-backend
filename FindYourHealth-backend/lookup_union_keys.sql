...
union
SELECT 'ServiceCategory', [Service Type] FROM [dbo].[Service Category] WHERE [Service Type] IS NOT NULL AND [Service Type] <> ''
union
SELECT 'ServiceSubcategory', [Service Subcategory] FROM [dbo].[Service Subcategory] WHERE [Service Subcategory] IS NOT NULL AND [Service Subcategory] <> ''
union
SELECT 'AgeGroup', [Age Group] FROM [dbo].[Age Groups] WHERE [Age Group] IS NOT NULL AND [Age Group] <> ''
union
SELECT 'InsuranceCompany', [Insurance Company] FROM [dbo].[Insurance Company] WHERE [Insurance Company] IS NOT NULL AND [Insurance Company] <> ''
union
SELECT 'InsurancePlan', [Plan] FROM [dbo].[Insurance Plans] WHERE [Plan] IS NOT NULL AND [Plan] <> ''
union
...
union
SELECT 'Suite_Building', [St/bldg] FROM [dbo].[Locations] WHERE [St/bldg] IS NOT NULL AND [St/bldg] <> ''
union
